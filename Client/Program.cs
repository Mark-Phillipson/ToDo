...
builder.Services.AddScoped<BlazorApp.Client.Services.ClipboardService>();
...
var clipboardService = host.Services.GetRequiredService<BlazorApp.Client.Services.ClipboardService>();
